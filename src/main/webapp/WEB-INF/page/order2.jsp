		...
		<div class="order cart mt">
			...
			<div class="orderCon wrapper clearfix">
				<div class="orderL fl">
					...
					<h3>收件信息<a href="/address/toAddress.do" class="fr">新增地址</a></h3>
					<!--------addres---------------->
				...
				<div class="orderR fr" >
					<div class="msg" >
						<h3>订单内容<a href="/car/toCart.do" class="fr">返回购物车</a></h3>
						<!--------ul---------------->
						<ul class="clearfix" v-for="(order, index) in orders">
							<li class="fl">
								<img src="/img/temp/order01.jpg">
							</li>
							<li class="fl">
								<p>{{order.xx.goodsName}}</p>
								<p>{{order.xx.tips}}</p>
								<p>数量：{{order.goodsNum}}</p>
							</li>
							<li class="fr">￥{{order.xx.price}}</li>
						</ul>
					</div>
					<!--------tips---------------->
					<div class="tips">
