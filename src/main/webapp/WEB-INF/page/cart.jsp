...
var goodsShow = {};
	...
	function settlement4JsonBody() {
		...
		$('.th :checkbox').each(function () {
			if ($(this).is(':checked')) {
				...
				var cardGood = goodsShow.shopCar[cardIndex];
				buyGoodArray.push({goodId : cardGood.goodsId, quantity : cardGood.goodsNum});
			}
		});
		...
		alert(msg);
		$.ajax({
		    url:'/order/addOrder4JsonBody.do',
		    type:'POST', //GET
		    ...
		    success:function(data,textStatus,jqXHR){
		        ...
		        //跳转到结算页
		        window.location.href='/order/toOrder.do'; 
		    },
	...
	function settlement1() {
		...
		for (var i=0; i<buyGoodArray.length; i++) {
			...
			msg += good.goodsId + '-' + good.goodsNum + '$';
		}
